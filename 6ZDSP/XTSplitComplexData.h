...
// $Id: XTSplitComplexData.h 141 2010-03-18 21:19:57Z mcdermj $
...
@interface XTSplitComplexData : NSObject {
	XTRealData *realData;
...
@property (readonly) void *realMutableBytes;
@property (readonly) void *imaginaryMutableBytes;
