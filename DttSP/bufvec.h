...
extern DTTSPCOMPLEX *newvec_COMPLEX(int size, char *tag);
extern void delvec_COMPLEX (DTTSPCOMPLEX * buf);
extern DTTSPCOMPLEX *newvec_COMPLEX_fftw(int size, char *tag);
extern void delvec_COMPLEX_fftw (DTTSPCOMPLEX * buf);
...
extern void dump_CX(FILE *fp, char *head, DTTSPCOMPLEX *ptr, int beg, int fin);

extern CXB newCXB(int size, DTTSPCOMPLEX *base, char *tag);
...
extern REAL normalize_vec_COMPLEX (DTTSPCOMPLEX *, int, REAL);
