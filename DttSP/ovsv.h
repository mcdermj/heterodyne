...
typedef struct _filt_ov_sav {
  int buflen, fftlen;
  DTTSPCOMPLEX *zfvec, *zivec, *zovec, *zrvec;
  fftwf_plan pfwd, pinv;
  REAL scale;
} filt_ov_sv, *FiltOvSv;

extern FiltOvSv newFiltOvSv (DTTSPCOMPLEX * coefs, int ncoef, int pbits);
extern void delFiltOvSv(FiltOvSv p);

extern DTTSPCOMPLEX *FiltOvSv_initpoint(FiltOvSv pflt);
extern int FiltOvSv_initsize(FiltOvSv pflt);

extern DTTSPCOMPLEX *FiltOvSv_fetchpoint(FiltOvSv pflt);
extern int FiltOvSv_fetchsize(FiltOvSv pflt);

extern DTTSPCOMPLEX *FiltOvSv_storepoint(FiltOvSv pflt);
