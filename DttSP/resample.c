		 ...
		 int interpFactor, int filterPhaseNum, int deciFactor)
{
  ...
  tmp->filterMemoryBuff =
     (DTTSPCOMPLEX *) safealloc (tmp->filterMemoryBuffLength, sizeof  (DTTSPCOMPLEX) ,
...
* *input               pointer to input DTTSPCOMPLEX data array
* *output              pointer to output DTTSPCOMPLEX data array
